          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <NavLink end to={"/Dashboard/Book/Add"} className="nav-link ">
                    Add Book
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink end to={"/Dashboard/Category/Add"} className="nav-link ">
                    Add Category
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink end to={"/Dashboard/Author/Add"} className="nav-link ">
                    Add Author
                  </NavLink>
                </li>
              </ul>
